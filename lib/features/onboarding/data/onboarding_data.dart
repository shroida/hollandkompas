...
const onboardingSlides = [
  OnboardingSlide(
    ...
    descAr: 'منهج شامل يأخذك من الصفر إلى مستوى B2 بخطوات منظمة ومدروسة.',
    tags: ['مفردات', 'قواعد', 'محادثة', 'قصص'],
    gradient: [Color(0xFFFF6B00), Color(0xFFE55A00)],
  ),
  ...
  OnboardingSlide(
    ...
    descAr: 'خوارزمية ذكية تتكيف مع مستواك وسرعة تعلمك.',
    tags: ['خطة يومية', 'أهداف شخصية', 'تقدم ذكي'],
  ...
  OnboardingSlide(
    ...
    descAr: 'نظام التكرار المتباعد يساعدك على تذكر الكلمات لفترة أطول.',
    tags: ['Flashcards', 'صوت النطق', 'تكرار متباعد'],
  ...
  OnboardingSlide(
    ...
    descAr: 'إحصائيات وشارات تحفزك على الاستمرار.',
    tags: ['إحصائيات', 'إنجازات', 'سلسلة يومية'],
